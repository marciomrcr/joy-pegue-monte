        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${slides[currentSlide].image.desktop})`,
              }}
            />
            {/* Mobile Image */}
            <div
              ...
              style={{
                backgroundImage: `url(${slides[currentSlide].image.mobile})`,
              }}
            />
          ...
          {/* Content */}
          <div className="relative z-10 top-48 md:top-32 flex h-full items-center">
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                ...
                >
                  <h1 className="mb-2 text-4xl hidden md:block font-bold bg-gradient-to-r from-rose-gold to-champagne bg-clip-text text-transparent md:text-5xl lg:text-6xl">
                    {slides[currentSlide].title}
                  </h1>

                  <h2 className="mb-4 text-xl hidden md:block font-light text-rose-100 md:text-2xl lg:text-3xl">
                  ...
                  <div className="flex flex-col gap-4  md:pt-8 mb-4 sm:flex-row">
                    <Button
                      variant="outline"
                      size="lg"
